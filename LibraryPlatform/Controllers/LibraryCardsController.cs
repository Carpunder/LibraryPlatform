...
namespace LibraryPlatform.Controllers
{
    public class LibraryCardsController
    {
        ...
        public void CreateUser(User user)
        {
            ...
            if (_context.Copies.Select(x => x.CopyNumber).Any())
            {
        ...
        public List<UserDTO> GetAllReader()
        {
            ...
            foreach(var user in _context.LibraryCards.Include("User").Where(x => x.LibraryId == Values.Values.CurrentLibraryValue))
            {
